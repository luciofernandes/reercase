 ...
 * @generated
 */
public class RmmPackageImpl extends EPackageImpl implements RmmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EEnum operationRestrictionIntegrityEEnum = null;
	 ...
	 * @see rmm.RmmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RmmPackageImpl() {
		super(eNS_URI, RmmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RmmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RmmPackage init() {
		if (isInited) return (RmmPackage)EPackage.Registry.INSTANCE.getEPackage(RmmPackage.eNS_URI);

		// Obtain or create and register package
		RmmPackageImpl theRmmPackage = (RmmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RmmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RmmPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRmmPackage.createPackageContents();

		// Initialize created meta-data
		theRmmPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRmmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RmmPackage.eNS_URI, theRmmPackage);
		return theRmmPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAssertion_Description() {
	 ...
	 * @generated
	 */
	public EAttribute getAssertion_Condition() {
	 ...
	 * @generated
	 */
	public EAttribute getDomain_IsNotNull() {
	 ...
	 * @generated
	 */
	public EReference getDomain_ConstraintCheckDomain() {
	 ...
	 * @generated
	 */
	public EAttribute getAttribute_IsNotNull() {
	 ...
	 * @generated
	 */
	public EAttribute getRelationship_Update() {
	 ...
	 * @generated
	 */
	public EAttribute getRelationship_Delete() {
	 ...
	 * @generated
	 */
	public EReference getPrimaryKey_Relationship() {
	 ...
	 * @generated
	 */
	public EReference getPrimaryKey_Attributes() {
	 ...
	 * @generated
	 */
	public EEnum getOperationRestrictionIntegrity() {
		return operationRestrictionIntegrityEEnum;
	}
	 ...
	 * @generated
	 */
	public RmmFactory getRmmFactory() {
		return (RmmFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(assertionEClass, ASSERTION__DESCRIPTION);
		createEAttribute(assertionEClass, ASSERTION__CONDITION);
		...
		createEAttribute(domainEClass, DOMAIN__IS_NOT_NULL);
		createEAttribute(domainEClass, DOMAIN__DATA_TYPE);
		createEReference(domainEClass, DOMAIN__CONSTRAINT_CHECK_DOMAIN);
		...
		createEAttribute(relationshipEClass, RELATIONSHIP__UPDATE);
		createEAttribute(relationshipEClass, RELATIONSHIP__DELETE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAssertion_Description(), ecorePackage.getEString(), "description", null, 0, 1, Assertion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssertion_Condition(), ecorePackage.getEString(), "condition", null, 0, 1, Assertion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDomain_IsNotNull(), ecorePackage.getEBoolean(), "isNotNull", "false", 0, 1, Domain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDomain_DataType(), this.getBaseType(), "dataType", null, 0, 1, Domain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDomain_ConstraintCheckDomain(), this.getCheck(), null, "constraintCheckDomain", null, 0, -1, Domain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationship_Update(), this.getOperationRestrictionIntegrity(), "update", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelationship_Delete(), this.getOperationRestrictionIntegrity(), "delete", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationship_Source(), this.getPrimaryKey(), null, "source", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationship_Target(), this.getForeignKey(), null, "target", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createGmf_2Annotations() {
		...
		addAnnotation
		  (getDomain_ConstraintCheckDomain(), 
		   source, 
		   new String[] {
			 "layout", "list",
			 "collapsible", "false",
