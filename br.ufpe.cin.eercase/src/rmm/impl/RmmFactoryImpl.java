 ...
 * @generated
 */
public class RmmFactoryImpl extends EFactoryImpl implements RmmFactory {
	/**
	 ...
	 * @generated
	 */
	public static RmmFactory init() {
		try {
			RmmFactory theRmmFactory = (RmmFactory)EPackage.Registry.INSTANCE.getEFactory(RmmPackage.eNS_URI);
			if (theRmmFactory != null) {
				return theRmmFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new RmmFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RmmPackage.SCHEMA: return createSchema();
			case RmmPackage.TABLE: return createTable();
			case RmmPackage.ASSERTION: return createAssertion();
			case RmmPackage.DOMAIN: return createDomain();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case RmmPackage.OPERATION_RESTRICTION_INTEGRITY:
				return createOperationRestrictionIntegrityFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case RmmPackage.OPERATION_RESTRICTION_INTEGRITY:
				return convertOperationRestrictionIntegrityToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public OperationRestrictionIntegrity createOperationRestrictionIntegrityFromString(EDataType eDataType, String initialValue) {
		OperationRestrictionIntegrity result = OperationRestrictionIntegrity.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertOperationRestrictionIntegrityToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
	 ...
	 * @generated
	 */
	public RmmPackage getRmmPackage() {
		return (RmmPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static RmmPackage getPackage() {
		return RmmPackage.eINSTANCE;
	}
