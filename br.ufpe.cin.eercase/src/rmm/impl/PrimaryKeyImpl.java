 ...
 * <ul>
 *   <li>{@link rmm.impl.PrimaryKeyImpl#getRelationship <em>Relationship</em>}</li>
 *   <li>{@link rmm.impl.PrimaryKeyImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimaryKeyImpl extends ConstraintImpl implements PrimaryKey {
	...
	protected EClass eStaticClass() {
		return RmmPackage.Literals.PRIMARY_KEY;
	}
	...
	public EList<Relationship> getRelationship() {
		if (relationship == null) {
			relationship = new EObjectContainmentEList<Relationship>(Relationship.class, this, RmmPackage.PRIMARY_KEY__RELATIONSHIP);
		}
		return relationship;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectResolvingEList<Attribute>(Attribute.class, this, RmmPackage.PRIMARY_KEY__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case RmmPackage.PRIMARY_KEY__ATTRIBUTES:
