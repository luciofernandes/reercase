 ...
 * <ul>
 *   <li>{@link reer.impl.SchemaImpl#getTable <em>Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaImpl extends EObjectImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return ReerPackage.Literals.SCHEMA;
	}
	...
	public EList<Table> getTable() {
		if (table == null) {
			table = new EObjectContainmentEList<Table>(Table.class, this, ReerPackage.SCHEMA__TABLE);
		}
		return table;
	}
