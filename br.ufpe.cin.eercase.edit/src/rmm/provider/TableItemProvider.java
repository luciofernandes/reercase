...
/**
 * This is the item provider adapter for a {@link rmm.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RmmPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RmmPackage.Literals.TABLE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RmmPackage.Literals.TABLE__ATTRIBUTES);
			childrenFeatures.add(RmmPackage.Literals.TABLE__CONSTRAINTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case RmmPackage.TABLE__NAME:
			case RmmPackage.TABLE__DESCRIPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case RmmPackage.TABLE__ATTRIBUTES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RmmPackage.Literals.TABLE__ATTRIBUTES,
				 RmmFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(RmmPackage.Literals.TABLE__CONSTRAINTS,
				 RmmFactory.eINSTANCE.createPrimaryKey()));
		...
		newChildDescriptors.add
			(createChildParameter
				(RmmPackage.Literals.TABLE__CONSTRAINTS,
				 RmmFactory.eINSTANCE.createForeignKey()));

		newChildDescriptors.add
			(createChildParameter
				(RmmPackage.Literals.TABLE__CONSTRAINTS,
				 RmmFactory.eINSTANCE.createCheck()));

		newChildDescriptors.add
			(createChildParameter
				(RmmPackage.Literals.TABLE__CONSTRAINTS,
				 RmmFactory.eINSTANCE.createTrigger()));
	}
