...
/**
 * This is the item provider adapter for a {@link reer.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReerPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_comment_feature", "_UI_Table_type"),
				 ReerPackage.Literals.TABLE__COMMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReerPackage.Literals.TABLE__ATTRIBUTES);
			childrenFeatures.add(ReerPackage.Literals.TABLE__ANNOTATTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReerPackage.Literals.TABLE__ATTRIBUTES,
		...
		newChildDescriptors.add
			(createChildParameter
				(ReerPackage.Literals.TABLE__ANNOTATTION,
				 ReerFactory.eINSTANCE.createAnnotation()));
	}
