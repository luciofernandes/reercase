 ...
 * @generated
 */
public class ReerViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ReerVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = ReerVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ReerElementTypes.isKnownElementType(elementType)
		...
		return TableEditPart.VISUAL_ID == visualID
				...
				|| AttributeUniqueKeyEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = ReerVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != ReerVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = ReerVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = ReerVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TableEditPart.VISUAL_ID:
		...
		case AttributeEditPart.VISUAL_ID:
			return createAttribute_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case AttributeUniqueKeyEditPart.VISUAL_ID:
			return createAttributeUniqueKey_3002(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ReerVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createTable_2001(EObject domainElement, View containerView,
		...
		node.setType(ReerVisualIDRegistry.getType(TableEditPart.VISUAL_ID));
	...
	public Node createAttribute_3001(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ReerVisualIDRegistry.getType(AttributeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createAttributeUniqueKey_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ReerVisualIDRegistry
	...
	public Node createAnnotation_3003(EObject domainElement,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ReerVisualIDRegistry.getType(AnnotationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createRelationship_4001(EObject domainElement,
		...
		edge.setType(ReerVisualIDRegistry
