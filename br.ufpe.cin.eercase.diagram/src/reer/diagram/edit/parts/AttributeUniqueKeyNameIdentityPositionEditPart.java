...
import reer.diagram.edit.policies.ReerTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AttributeUniqueKeyNameIdentityPositionEditPart extends
	 ...
	 * @generated
	 */
	public AttributeUniqueKeyNameIdentityPositionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ReerTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ReerParserProvider
					.getParser(
							ReerElementTypes.AttributeUniqueKey_3002,
							getParserElement(),
							ReerVisualIDRegistry
									.getType(reer.diagram.edit.parts.AttributeUniqueKeyNameIdentityPositionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ReerEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
