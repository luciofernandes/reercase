 ...
 * @generated
 */
public class TableItemSemanticEditPolicy extends ReerBaseItemSemanticEditPolicy {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (ReerVisualIDRegistry.getVisualID(node)) {
			case TableTableAttributesCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (ReerVisualIDRegistry.getVisualID(cnode)) {
