 ...
 * @generated
 */
public class RmmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SchemaEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& RmmVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RmmVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RmmVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!RmmElementTypes.isKnownElementType(elementType)
				...
				if (!SchemaEditPart.MODEL_ID.equals(RmmVisualIDRegistry
		...
		return TableEditPart.VISUAL_ID == visualID
				...
				|| Check2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RmmVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RmmVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = RmmVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = RmmVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case TableEditPart.VISUAL_ID:
			return createTable_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case AssertionEditPart.VISUAL_ID:
			return createAssertion_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case DomainEditPart.VISUAL_ID:
			return createDomain_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case PrimaryKeyEditPart.VISUAL_ID:
		...
		case ForeignKeyEditPart.VISUAL_ID:
			return createForeignKey_3024(domainElement, containerView, index,
					persisted, preferencesHint);
		case CheckEditPart.VISUAL_ID:
			return createCheck_3025(domainElement, containerView, index,
					persisted, preferencesHint);
		case TriggerEditPart.VISUAL_ID:
			return createTrigger_3026(domainElement, containerView, index,
					persisted, preferencesHint);
		case AttributeEditPart.VISUAL_ID:
			return createAttribute_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case Check2EditPart.VISUAL_ID:
			return createCheck_3021(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTable_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(TableEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createAssertion_2007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(AssertionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createDomain_2008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(
				NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(DomainEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(
				node,
				RmmVisualIDRegistry
						.getType(DomainDomainConstraintCheckDomainCompartmentEditPart.VISUAL_ID),
				false, false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createPrimaryKey_3022(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(PrimaryKeyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5030 = createLabel(node,
				RmmVisualIDRegistry.getType(PrimaryKeyIDNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createForeignKey_3024(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(ForeignKeyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5032 = createLabel(node,
				RmmVisualIDRegistry.getType(ForeignKeyIDNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createCheck_3025(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(CheckEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createTrigger_3026(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(TriggerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Node createAttribute_3006(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(AttributeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createCheck_3021(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RmmVisualIDRegistry.getType(Check2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createRelationship_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
