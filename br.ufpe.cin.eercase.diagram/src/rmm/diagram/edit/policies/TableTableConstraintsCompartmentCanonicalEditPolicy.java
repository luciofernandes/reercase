 ...
 * @generated
 */
public class TableTableConstraintsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RmmPackage.eINSTANCE.getTable_Constraints();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<RmmNodeDescriptor> childDescriptors = RmmDiagramUpdater
				.getTableTableConstraintsCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<RmmNodeDescriptor> childDescriptors = RmmDiagramUpdater
				.getTableTableConstraintsCompartment_7005SemanticChildren((View) getHost()
						.getModel());
