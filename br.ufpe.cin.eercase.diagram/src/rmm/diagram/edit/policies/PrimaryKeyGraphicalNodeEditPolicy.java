...
import rmm.diagram.edit.commands.RmmReorientConnectionViewCommand;
import rmm.diagram.providers.RmmElementTypes;

/**
 * @generated
 */
public class PrimaryKeyGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionCompleteCommand(
		...
		if (RmmElementTypes.Relationship_4002 == elementType) {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		RmmReorientConnectionViewCommand rcvCommand = new RmmReorientConnectionViewCommand(
				editingDomain, null);
