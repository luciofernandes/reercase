 ...
 * @generated
 */
public class RmmBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected RmmBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						RmmVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = RmmElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = RmmDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			RmmDiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateRelationship_4003(ForeignKey container,
				PrimaryKey source, ForeignKey target) {
		 ...
		 * @generated
		 */
		public boolean canExistRelationship_4003(ForeignKey container,
				Relationship linkInstance, PrimaryKey source, ForeignKey target) {
			return true;
		}
	}
