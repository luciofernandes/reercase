 ...
 * @generated
 */
public class AssertionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AssertionNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RmmTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return RmmElementTypes.getImage(parserElement.eClass());
	}
		...
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							...
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.AssertionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					RmmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
