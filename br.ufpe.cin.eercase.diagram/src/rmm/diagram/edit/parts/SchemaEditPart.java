...
import rmm.diagram.edit.commands.RmmCreateShortcutDecorationsCommand;
import rmm.diagram.edit.policies.SchemaCanonicalEditPolicy;
import rmm.diagram.edit.policies.SchemaItemSemanticEditPolicy;
...
public class SchemaEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Rmm"; //$NON-NLS-1$
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new RmmCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
