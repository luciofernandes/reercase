 ...
 * @generated
 */
public class AttributeNameDataTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AttributeNameDataTypeEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							...
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.AttributeNameDataTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
