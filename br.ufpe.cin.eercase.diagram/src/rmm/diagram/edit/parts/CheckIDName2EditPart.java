 ...
 * @generated
 */
public class CheckIDName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CheckIDName2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							...
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.CheckIDName2EditPart.VISUAL_ID));
		}
		return parser;
	}
