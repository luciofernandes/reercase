...
import rmm.diagram.edit.policies.TableItemSemanticEditPolicy;
...
public class TableEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableTableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getTableConstraintsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TableTableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TableTableConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getTableConstraintsCompartmentFigure();
			pane.remove(((TableTableConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof TableTableConstraintsCompartmentEditPart) {
			return getPrimaryShape().getTableConstraintsCompartmentFigure();
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == RmmElementTypes.Attribute_3006) {
				return getChildBySemanticHint(RmmVisualIDRegistry
			...
			if (type == RmmElementTypes.Check_3025) {
				return getChildBySemanticHint(RmmVisualIDRegistry
						.getType(TableTableConstraintsCompartmentEditPart.VISUAL_ID));
			}
			if (type == RmmElementTypes.Trigger_3026) {
				return getChildBySemanticHint(RmmVisualIDRegistry
						.getType(TableTableConstraintsCompartmentEditPart.VISUAL_ID));
			}
		}
	...
	public class TableFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fTableConstraintsCompartmentFigure;
		...
		private void createContents() {
			...
			fTableConstraintsCompartmentFigure = new RectangleFigure();

			fTableConstraintsCompartmentFigure.setOutline(false);

			this.add(fTableConstraintsCompartmentFigure);
			fTableConstraintsCompartmentFigure
					.setLayoutManager(new StackLayout());
		 ...
		 * @generated
		 */
		public RectangleFigure getTableConstraintsCompartmentFigure() {
			return fTableConstraintsCompartmentFigure;
		}
