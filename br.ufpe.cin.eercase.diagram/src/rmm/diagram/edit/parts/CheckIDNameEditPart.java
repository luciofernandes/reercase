 ...
 * @generated
 */
public class CheckIDNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CheckIDNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							...
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.CheckIDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
