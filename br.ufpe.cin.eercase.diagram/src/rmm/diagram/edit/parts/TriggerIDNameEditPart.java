 ...
 * @generated
 */
public class TriggerIDNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TriggerIDNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							...
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.TriggerIDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
