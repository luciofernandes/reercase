 ...
 * @generated
 */
public class ForeignKeyIDNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ForeignKeyIDNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							RmmElementTypes.ForeignKey_3024,
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.ForeignKeyIDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
