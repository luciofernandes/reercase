 ...
 * @generated
 */
public class PrimaryKeyIDNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PrimaryKeyIDNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RmmParserProvider
					.getParser(
							RmmElementTypes.PrimaryKey_3022,
							getParserElement(),
							RmmVisualIDRegistry
									.getType(rmm.diagram.edit.parts.PrimaryKeyIDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
