...
import rmm.diagram.edit.policies.AttributeItemSemanticEditPolicy;
...
public class AttributeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AttributeNameDataTypeEditPart) {
			((AttributeNameDataTypeEditPart) childEditPart)
	...
	public class AttributeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			Attribute attribute = ((Attribute) ((Node) AttributeEditPart.this
					.getModel()).getElement());
