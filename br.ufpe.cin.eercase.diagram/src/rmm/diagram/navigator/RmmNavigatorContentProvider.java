...
import rmm.diagram.part.Messages;
import rmm.diagram.part.RmmVisualIDRegistry;

/**
 * @generated
 */
public class RmmNavigatorContentProvider implements ICommonContentProvider {
	...
	public RmmNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<RmmNavigatorItem> result = new ArrayList<RmmNavigatorItem>();
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, SchemaEditPart.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof RmmNavigatorGroup) {
			RmmNavigatorGroup group = (RmmNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof RmmNavigatorItem) {
			RmmNavigatorItem navigatorItem = (RmmNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SchemaEditPart.VISUAL_ID: {
			...
			RmmNavigatorGroup links = new RmmNavigatorGroup(
					Messages.NavigatorGroupName_Schema_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RmmVisualIDRegistry.getType(TableEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RmmVisualIDRegistry.getType(AssertionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					RmmVisualIDRegistry.getType(DomainEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case TableEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(
					...
					RmmVisualIDRegistry
							.getType(TableTableConstraintsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					RmmVisualIDRegistry.getType(AlternateKeyEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(
					...
					RmmVisualIDRegistry
							.getType(TableTableConstraintsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					RmmVisualIDRegistry.getType(CheckEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
					RmmVisualIDRegistry
							.getType(TableTableConstraintsCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					RmmVisualIDRegistry.getType(TriggerEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
			...
			connectedViews = getChildrenByType(connectedViews,
					RmmVisualIDRegistry.getType(AttributeEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case DomainEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(connectedViews,
					RmmVisualIDRegistry.getType(Check2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case PrimaryKeyEditPart.VISUAL_ID: {
			LinkedList<RmmAbstractNavigatorItem> result = new LinkedList<RmmAbstractNavigatorItem>();
			Node sv = (Node) view;
			RmmNavigatorGroup outgoinglinks = new RmmNavigatorGroup(
					Messages.NavigatorGroupName_PrimaryKey_3022_outgoinglinks,
		...
		case ForeignKeyEditPart.VISUAL_ID: {
			LinkedList<RmmAbstractNavigatorItem> result = new LinkedList<RmmAbstractNavigatorItem>();
			Node sv = (Node) view;
			RmmNavigatorGroup incominglinks = new RmmNavigatorGroup(
					Messages.NavigatorGroupName_ForeignKey_3024_incominglinks,
	 ...
	 * @generated
	 */
	private Collection<RmmNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<RmmNavigatorItem> result = new ArrayList<RmmNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new RmmNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private Collection<RmmNavigatorItem> getForeignShortcuts(Diagram diagram,
			Object parent) {
		LinkedList<View> result = new LinkedList<View>();
	...
	public Object getParent(Object element) {
		if (element instanceof RmmAbstractNavigatorItem) {
			RmmAbstractNavigatorItem abstractNavigatorItem = (RmmAbstractNavigatorItem) element;
